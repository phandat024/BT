                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.postUpdateUser') }}" id="registration-form" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <input type="text" placeholder="Tin chi" id="tinchi" class="form-control"
                                           name="tinchi" required autofocus>
                                </div>

                                <div class="form-group mb-3">
                                    <input type="text" placeholder="Dia chi" id="diachi" class="form-control"
                                           name="diachi" required autofocus>
                                </div>
